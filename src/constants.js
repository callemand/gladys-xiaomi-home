...
//
// The RPC method names and state codes below say "Roborock" because that is what
// the robot firmware speaks — the same commands answer whether the robot is
// reached through the Xiaomi cloud or the Roborock one. This integration only
// ever talks to the Xiaomi one (miIO).
